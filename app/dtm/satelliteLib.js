    ...
    for (var key in obj){
      if (obj.hasOwnProperty(key)){
        ...
        if (SL.isObject(value)){
          ...
          ret[key] = SL.replace(value, elm, evt)
        }
      }
    }
    return ret
...
SL.getVar = function(variable, elm, evt){
  ...
  if (value === undefined){
    if (variable.substring(0, 5) === 'this.'){
      ...
      return SL.getObjectProperty(elm, variable, true)
...
function ShakeEventEmitter() {
    ...
    if ('ondevicemotion' in window) SL.addEventHandler(window, 'devicemotion', SL.bind(this.devicemotion, this));
}

//calculates if shake did occur
ShakeEventEmitter.prototype.devicemotion = function (e) {
    ...
    if (((deltaX > this.threshold) && (deltaY > this.threshold)) || ((deltaX > this.threshold) && (deltaZ > this.threshold)) || ((deltaY > this.threshold) && (deltaZ > this.threshold))) {
        ...
        if (timeDifference > 1000) {
            SL.onEvent({type: 'shake', target: e.target});
...
SL.availableEventEmitters.push(ShakeEventEmitter);
...
SL.extend(DefaultTool.prototype, {
  ...
  loadScripts: function(elm, evt, scripts) {
    ...
    var scripts = scripts.slice(0)
      ...
      console.error('scripts is', JSON.stringify(scripts))
    }
    function loadNext(){
...
SL.extend(SiteCatalystTool.prototype, {
  ...
  getS: function(s, options){
    ...
    var varBindings = options && options.setVars || this.varBindings
  ...
  $trackLink: function(elm, evt, params){
    ...
    SL.notify("Adobe Analytics: tracked link", 1)
  },
...
SL.extend(Tnt.prototype, {
  ...
  , $addMBoxStep2: function(elm, evt, settings){
    ...
    var self = this
    var forceLowerCase = this.settings.forceLowerCase
...
_satellite.init({
 "tools": {
    "f9ec63014d054a68d6e6115606cd4765": {
        "engine": "sc",
        "loadOn": "pagebottom",
        ...
        "renameS": "s",
        "initVars": {
            //"server": "adobetagmanagerengineering.d2.sc.omtrdc.net",
            ...
            "trackInternalFilter": "javascript:, mailto:, tel:",
  ...
  "rules": [
    {
      ...
      "trigger": [{
        ...
        "arguments": [{
          "sequential": false,
          "scripts": [{
            "src": "satellite-5306933515f50783e6000061-staging.js",
            "data": []
          }]
        }]
      },{
  ...
  "settings": {
    ...
    "libraryName": "satelliteLib-3abe4eced7853086d6853d946b96c0dbeeb78445",
    "isStaging": true,
...
,
    ...
    "revenue": "",
    "host": {
      "http": "www.designstation.ro/serban/dtm-sneak-grid",
      "https": "www.designstation.ro/serban/dtm-sneak-grid",
    }
  },
  "dataElements": {
      "Sneak": {
          "selector": "#selectsneak",
          "property": "value",
  ...
  "buildDate": "2014-02-20 23:47:11 UTC"
});
})(window, document);
